...
function JournalCard({ article }) {
  return (
    <Link href={`/journal/${article.slug}`} className="jcard"
      aria-label={`Read: ${article.title}`} style={{ cursor: "pointer", textDecoration: "none" }}
    >
...
function FeaturedCycler({ articles }) {
  ...
  return (
    <div style={{ marginBottom: "52px" }}>
      ...
      >
        <Link href={`/journal/${article.slug}`} className="jc-featured-grid" style={{ cursor: "pointer", textDecoration: "none" }}>
...
export default function JournalClient() {
  return (
    <>
      ...
      <FeaturedCycler articles={journalArticles} />
      ...
      <CardSlider articles={journalArticles} />
