...
const IMAGE_INVENTORY = {
  "Jaipur at down": [
    "thumbnail.jpg",
    "image1.jpeg",
    "IMG20250731114958.jpg",
    "IMG_20250914_132635_152.jpg",
    "IMG20251105100216.jpg",
  ...
  "The Cosmic & Imperial Triad": [
    ...
    "IMG20251009155510.jpg",
    "IMG20251009155525.jpg",
    "IMG20251009160028.jpg",
  ...
  "Beyond the pink": [
    ...
    "IMG_20260123_140614.jpg",
    "IMG_20260213_143023.jpg",
...
metaDescription: "A sunrise walking tour through Jaipur's temples, flower markets and local eateries — see the old city before the crowds arrive, with Raah Experiences.",
  ...
  glancePoints: [
    "Morning devotion at Govind Dev Ji Temple — join the aarti ceremony and devotional songs",
    "Wander through the vibrant phool & sabzi mandi (flower & vegetable market) — a genuine social hub of the city",
    "Take a glimpse at the doodh mandi (Milk Market), where countryside milkmen arrive on bicycles & motorbikes at dawn",
    "Marvel at Hawa Mahal as the rising sun transforms its majestic façade into a surreal spectacle",
    "Discover the splendid Tripoliya Gate, renowned for the Teej & Gangaur Festivals and entry to the City Palace",
  ...
  story: `As the name suggest the experience takes place before anyone would wake up in the city of Jaipur aside from locals. The tour begins with capturing the movement of locals early in the morning before sunrise where farmers carry fresh vegetables, milkmen carrying multiple milk containers, elders approaching temples to seek blessings, and local eateries preparing for day.\n\nWe start our day like every Jaipur local and we trace the footprints of those to live a simple yet joyous life. Begin a day with the divine blessings of Lord Krishna at Govind Dev Ji Temple, revered as the ruler, protector & spiritual heart of the city. Take part in the aarti ceremony, join people singing devotional songs and follow the fascinating rituals people do while offering prayers at the temple. Continuing ahead, wander through the vibrant flower & vegetable markets, commonly known as phool & sabzi mandi where you can feel the true soul of the city coming alive with vendors yelling price in a rhythmic tone, wooden carts & stalls filled with fresh fruits & vegetables, florists weaving colorful garlands, local haggling over an everyday staple and energetic women carrying weight above their heads. In a true sense it is a perfect cultural exchange. In true sense, unlike other markets, vegetable & flower markets are a perfect social hub offering a genuine, warmth & joyous spirit of a city.\n\nTake a glimpse at Milk Market, locally known as doodh mandi, where countryside people arrive on bicycles & motorbikes loaded with milk containers to supply in the neighborhood. The milk is not only supplied to local residents but also to sweet shops & tea stalls who does check the purity, fat content, temperature and richness.\n\nThe experience later on passes through the iconic façade of Jaipur, the Hawa Mahal, a dramatic window at the back part of the palace allowing their residents especially women bounded by purdah can effectively watch out the city's chaos, festivals and even procession of Maharajas. This is not all, the walk does takes you through the narrow & quieter lanes that is filled with vibrant energy when the city comes to its original state.\n\nBesides this, marvel at the splendid Tripoliya Gate renowned for processing Teej & Gangaur Festivals, important cultural fest in Jaipur with an entry to the City Palace—a house of existing royal family in Jaipur. Before concluding a walk, do not forget to sit at a local tea stall to indulge in a deep conversation about the history, culture & people of Jaipur city with a scrumptious breakfast at local eateries known for their secret recipes & generation led businesses.\n\nWhile exploring the streets & lanes of Jaipur you might also come across local people sharing their warm & friendly greetings with you. Everyone here would accept you with a genuine & big smile on their face & a true heart filled with honor & pride for them to experience their Jaipur.\n\nThe "Jaipur at Dawn" is not merely a walk but a deep sense of connection with its people and the city before it takes the most common & touristic form. So, get ready to experience Jaipur when it is more natural, cool, & realistic than any other time of a day.`,
  whatYouExperience: [
    "Morning devotion at Govind Dev Ji Temple — join the aarti ceremony and devotional songs",
  ...
  highlights: [
    ...
    { icon: "🌸", text: "Phool & sabzi mandi (flower market)" },
    { icon: "🥛", text: "Doodh mandi (Milk Market)" },
    { icon: "🛕", text: "Morning temple rituals" },
    { icon: "🚪", text: "Tripoliya Gate & City Palace" },
  ...
  faqs: [
    ...
    { q: "Is this walk safe for solo female travelers?", a: "Yes. Our guide accompanies the group throughout, and the route stays within well-populated areas of the Old City even at dawn." },
  ],
},
  ...
  // ── 2. The Ridge & Ramparts ──────────────────────────────────────
  {
    ...
    glancePoints: [
      "Take mesmerizing pictures of Amber Fort from the outskirts of the town, walking through a deep valley of abandoned temples and gardens",
      "Witness Asiatic elephants living harmoniously alongside the local community",
      "Visit the Jagat Shiromani Temple — a 16th-century architectural wonder with a striking single-piece marble arched doorway (toran dwar)",
      "Discover Amber's ancient stepwells — a social hub where local women gathered while completing daily chores",
      "Explore Amber Fort's four courtyards, including Ganesh Pol, Sattais Kacheri, Diwan-e-Aam, Jai Mandir (Mirror Palace), Sukh Niwas & Suhag Mandir",
      "Walk the historic secret tunnel connecting Amber to Jaigarh Fort, once used by the royal family",
      "Marvel at the Jaivana cannon — the world's biggest & heaviest cannon, weighing 150 tons",
      "Take in breathtaking views of Amber Fort, Sagar Lake & the Amber Hills from the charbagh garden of Jaigarh Fort",
    ],
    beforeYouCome: {
      duration: "4–5 hrs",
    ...
    story: `The experience Ridge & Ramparts here to the fascinating experience that takes place in a small & quaint town of Amber, the citadel of the erstwhile rulers of Jaipur. The town is known worldwide for having a UNESCO World Heritage Site Amber Fort & Palace, but there is lot more to see beyond this. The Walk or an experience was designed keeping in mind the other valuable elements that makes the town of Amber more beautiful & historical if we go beyond the forts & Palaces.\n\nWe kick start the walk by taking mesmerizing pictures of the Amber Fort with its surrounding on the outskirts of the town. Slowly & gradually the walk winds through the deep valley comprising of abandoned temples, beautiful gardens and the walkways of the world's third longest wall. As the walk starts in the morning, you can also witness Asiatic elephants living harmoniously alongside the local community, as they have them since ages. It is remarkable to see wildlife & people co-existing so closely. Before approaching the Amber Fort, we would take you through the Amber town which has a massive collection of small & large temples, havelis (traditional mansions), water reservoirs, wells, gateways, and local life thriving peacefully. We would make a visit to some of the temples and amongst those stands out the Jagat Shiromani Temple, an architectural wonder constructed in 16th century. One of the striking features of this temple is its marble arched doorway (toran dwar), carved from a made single piece of white marble with detailed, intricate patterns & magnificent statues.\n\nAlong the way, make a stop to marvel at ancient engineering of collecting & storing a water in a deep-water reservoir called stepwells. These structures were more like a social hub allowing the local women to complete their daily chores while engaging with the neighbors. Filled with cool water, these impressive structures also provide a pleasant setting for elders to walk, relax & socialize with friends, family & neighbors.\n\nTaking a short but scenic staircase allows to reach at the Amber Fort to explore & capture the panoramic views of the town. Here we can understand the topography and witness some of the other hidden treasures. The Palace has four different courtyard each one with distinctive architectural marvel combining different elements of Hindu & Mughal Architecture. Some of the astonishing structures are Ganesh Pol, Sattais Kacheri, Diwan-e-Aam, Jai Mandir (Mirror Palace), Sukh Niwas (Hall of pleasures) & Suhag Mandir.\n\nAfter visiting a fort, the walk continues to the invincible Jaigarh Fort, a massive defensive structure overlooking the Amber palace, town and its surroundings. Unlike others, we would use a secret tunnel designed for the royal family to reach the fort, disguised & protected by invaders. Marvel at the Jaivana cannon, world's biggest & heaviest cannon weighing 150 tons which is said to be fired just once!\n\nBefore coming down, do not forgot to witness the biggest water storage tank built for water conservation & a scenic spot from the charbagh garden of Jaigarh fort—offering breathtaking views of the Amber Fort, Sagar Lake & the dense forests of Amber Hills.`,
    whatYouExperience: [
      "Take mesmerizing pictures of Amber Fort from the outskirts of the town, walking through a deep valley of abandoned temples and gardens",
      "Witness Asiatic elephants living harmoniously alongside the local community",
      "Visit the Jagat Shiromani Temple — a 16th-century architectural wonder with a striking single-piece marble arched doorway (toran dwar)",
    ...
    highlights: [
      ...
      { icon: "🐘", text: "Asiatic elephants of Amber" },
      { icon: "🛕", text: "Jagat Shiromani Temple" },
      { icon: "🪜", text: "Ancient stepwells" },
      { icon: "👑", text: "Secret royal tunnel" },
      { icon: "💣", text: "The Jaivana cannon" },
      { icon: "🌳", text: "Charbagh garden views" },
      { icon: "👥", text: "Small group experience" },
    ],
    ...
    faqs: [
      ...
      { q: "Is the secret tunnel to Jaigarh Fort safe to walk through?", a: "Yes. The tunnel is a well-maintained historic passage, not an off-trail route. We walk it with full knowledge of the terrain and appropriate lighting." },
    ],
  },
  ...
  // ── 3. The Cosmic & Imperial Triad ──────────────────────────────
  {
    ...
    subtitle: "Where Royalty, Astronomy and Architecture meet",
    ...
    glancePoints: [
      "Discover how Jaipur's nine planned blocks worked — with the central block reserved for the royal family, temples, administrative offices, and Jaleb Chowk",
      "Uncover the surprising truth about Hawa Mahal — its famous façade is actually the back of the palace",
      "Learn how Jantar Mantar's instruments calculate local time, zodiac signs, moon sign & rising sign with striking precision",
      "Marvel at the Virat Samrat Yantra — the world's biggest sundial",
      "Explore the City Palace's museums, courtyards, doorways, patios & galleries, uncovering untold stories of the erstwhile rulers",
      "End the walk with a tuk-tuk ride through the city's bustling everyday life and vibrant street culture",
    ],
    beforeYouCome: {
      duration: "2.5–3 hrs",
    ...
    story: `As the name suggests, "The Crown of Jaipur" is a well curated walk planned in the heart of the walled city of Jaipur. Out of the nine blocks of Jaipur's meticulous planning, the central block was planned for the royal family comprising the royal palace, temples, administrative offices, Jaleb chowk, and numerous doors protecting the royal complex from any invasions.\n\nThe experience takes you through the three iconic landmarks of Jaipur featuring Hawa Mahal, Jantar Mantra & City Palace. Though the walk seems to be quite common with these places which does also appear in every travel itinerary but "The Crown of Jaipur" takes you back in time to understand the vision of the city's founder—Sawai Jai Singh II.\n\nThe experience begins at the Hawa Mahal, or Palace of Winds, located dramatically on the edge of the main street. This monument was built as a humble tribute to Lord Krishna, and its alluring architecture captivates every passerby. While there are numerous fascinating facts about the structure, one of the most surprising is its orientation: what appears to be the impressive front façade is actually the back of the palace. While marvelling at its beauty, you will uncover some of other mysterious facts about the palace.\n\nContinuing ahead, the walks take us at another innovation made by City's founder along with Jaipur—Jantar Mantar, the royal observatory. This is one of the biggest, better conserved, featuring more instruments with better accuracy as compared to other four observatories built by the king in India. You will learn the techniques of calculating the local time, zodiac signs, moon sign, rising sign (ascendant) and as well as the prediction of monsoon with great precision. This is not all; the observatory does also have world's biggest sundial in the world—Virat Samrat Yantra.\n\nContinuing ahead, the walk now turns into the royal residence of the present royal family of Jaipur—The City Palace. Here as the part of our walk, you will be uncovering some untold stories of the erstwhile rulers and discovering the City Palace at its best through its museums, courtyards, doorways, patios, palatial buildings and galleries. If you are a true travel enthusiast with a passion for photography, royal architecture, and heritage, or simply wish to experience authentic grandeur, a royal tour of the City Palace in Jaipur is your perfect gateway.\n\nAfter completion of the tour, take a chance to explore the city with a tuk-tuk ride, a unique way to be the part of city's bustling everyday life & vibrant street culture.`,
    whatYouExperience: [
      "Discover how Jaipur's nine planned blocks worked — with the central block reserved for the royal family, temples, administrative offices, and Jaleb Chowk",
      "Uncover the surprising truth about Hawa Mahal — its famous façade is actually the back of the palace",
      "Learn how Jantar Mantar's instruments calculate local time, zodiac signs, moon sign & rising sign with striking precision",
    ...
    highlights: [
      { icon: "🏛️", text: "Three historic landmarks — one story" },
      { icon: "🚪", text: "Nine planned blocks & Jaleb Chowk" },
      { icon: "🪟", text: "Hawa Mahal's hidden back-façade secret" },
      { icon: "🔭", text: "Virat Samrat Yantra — world's biggest sundial" },
      { icon: "👑", text: "City Palace museums & courtyards" },
      { icon: "📐", text: "Astronomy meets architecture" },
      { icon: "🛺", text: "Tuk-tuk ride through the old city" },
    ...
    faqs: [
      ...
      { q: "Is the tuk-tuk ride included in the price?", a: "Yes, the tuk-tuk ride at the end of the walk is included as part of the experience — a fun way to soak in the city's everyday street life before we say goodbye." },
    ],
  },
  ...
  // ── 4. The Blue Hour ────────────────────────────────────────────
  {
    ...
    glancePoints: [
      "Watch the sunset from Nahargarh Fort, the most happening hilltop spot in Jaipur",
      "Ride through a scenic verdant valley in an open-air jeep to reach Madhavendra Bhawan — the nine-apartment mansion built for the king's nine queens",
      "Enjoy a cool drink and glimpses of the Sound & Light Show in front of the majestic Amber Fort & Palace",
      "Stop for photos at Jal Mahal, reflecting in the shimmering waters of Man Sagar Lake",
      "Drive past Hawa Mahal and uncover facts that make its façade even more fascinating",
      "Witness Ishwari Laat — the tallest minaret in Jaipur — and the Albert Hall Museum, home to Rajasthan's finest artefact collection",
      "Conclude at Patrika Gate & Toran Dwar, two gateways famous for their craftsmanship and colour",
      "End the evening with a stop at a handpicked, trending local spot for snacks & drinks",
    ],
    beforeYouCome: {
    ...
    story: `While most visitors stick to the standard day routine sightseeing, "The Blue Hour" offers something unique & beyond imagination. Designed to unlock the city by night, it reveals a captivating side of Jaipur that most people completely miss. The Blue Hour Journey starts with experiencing the sunset from Nahargarh Fort, the most happening place in Jaipur. Situated a top hill, the fort not only offers the best panoramic views of the city but also a memorable evening that one can spend with their beloved ones.\n\nThe open-air jeep takes you through the scenic verdant valley to reach a top before sunrise to visit the Madhvendra Bhawan, a set of 9 apartment mansion built by the king for his nine queens. These apartments are contemporaries of Havelis where Nobels, artisans, merchants and people with high status used to live. After a cool drink & a romantic sunset, the experience continues to unfold in front of the majestic Amber Fort & the Palace where we can enjoy the glimpses of resplendent Sound & Light Show. Since the experience the entirely private, you can also choose to watch the complete show sitting in an amphitheatre. Perched majestically atop the Aravalli Hills, Amber Fort & Palace is a UNESCO World Heritage Site, renowned for its imposing hilltop location, magnificent Rajput-Mughal architecture & centuries old rich history.\n\nFrom there, our journey continues into the heart of the city, passing through city's iconic illuminated landmarks including Jal Mahal, Hawa Mahal, the Albert Hall Museum and Birla Temple---before concluding at Patrika Gate & Toran Dwar.\n\nAs we approach the city, stop for a photo at Jal Mahal to enjoy a fresh & cool evening against a perfect backdrop of water palace reflecting in the shimmering waters of Man Sagar Lake. The drive later on weaves through the different doorways & streets to showcase you the true beauty of Jaipur. Marvel at Hawa Mahal while we drive pass & unveil some of its interesting facts that makes the façade more beautiful than it actually looks.\n\nThe route continues ahead to witness Ishwari Laat, the tallest minaret in Jaipur built to commemorate the victory of then ruler over his step brother. Just a moment away, we stop at Albert Hall Musuem, renowned as the State Museum of Rajasthan due to its impressive collection of Indian & International artefacts spanning centuries.\n\nFrom there, the journey unfolds towards Patrika Gate & Toran Dwar, two impressive gateways famous for their unique craftsmanship, striking colors & stunning backdrop.\n\nCruising in an open jeep offers the ultimate way to experience Jaipur's vibrant energy. You will pass through bustling streets, lively markets, and colourful architecture, all set against the city's signature chaotic charm. As evening sets in, the air comes alive with the scent of fresh incense, the chime of temple bells, and the irresistible aromas of street food being prepared along the way. We'll also make thoughtful stops wherever possible to soak in & photograph the vibrant energy of each place.\n\nBefore dropping you off, if you want to try some of the delicious cuisine in Jaipur, we can schedule a stop at handpicked & trending places in Jaipur to enjoy delicious snacks & drinks.`,
    whatYouExperience: [
      "Watch the sunset from Nahargarh Fort, the most happening hilltop spot in Jaipur",
      "Ride through a scenic verdant valley in an open-air jeep to reach Madhavendra Bhawan — the nine-apartment mansion built for the king's nine queens",
      "Enjoy a cool drink and glimpses of the Sound & Light Show in front of the majestic Amber Fort & Palace",
    ...
    highlights: [
      ...
      { icon: "🚙", text: "Open-air jeep through verdant valleys" },
      { icon: "👑", text: "Madhavendra Bhawan — the nine queens' mansion" },
      { icon: "🏰", text: "Amber Fort Sound & Light Show" },
      { icon: "💎", text: "Jal Mahal on Man Sagar Lake" },
      { icon: "🕌", text: "Ishwari Laat & Albert Hall Museum" },
      { icon: "🎨", text: "Patrika Gate & Toran Dwar" },
      { icon: "🍽️", text: "Local snacks & drinks stop" },
    ],
